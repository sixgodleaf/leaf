...
public class QNMinimizer implements Minimizer<DifferentiableFunction> {
    ...
    private static double[] plusAndConstMult(double[] a, double[] b, double c,
        ...
        for (int i = 0; i < a.length; i++) {
            System.out.println("a: " + a[i] + "\t" + "b: " + b[i] + "\t" + c);
            d[i] = a[i] + c * b[i];
        }
        return d;
    }
    ...
    public double[] minimize(DifferentiableFunction dfunction,
        ...
        do {
            ...
            try {
                ...
                for (Double dirParam : dir) {
                    System.out.println("dir0: " + dirParam);
                }
                ...
                for (Double dirParam : dir) {
                    System.out.println("dir1: " + dirParam);
                }
                System.out.println("lsOpt: " + lsOpt);
        ...
        System.out.println("evaluateIters" + state);
        // if (evaluateIters > 0) {
        // // do final evaluation
        // doEvaluation(x);
        // }
    ...
    private double[] lineSearchMinPack(DifferentiableFunction dfunc,
        ...
        do {
            ...
            // conditions.
            System.out.println("plusAndConstMult: " + aMin);
            ...
            System.out.println("difunc: " + newPt[f]);
            newPt[f] = dfunc.valueAt((plusAndConstMult(x, dir, newPt[a], newX)));
            System.out.println("newPt[f]: " + newPt[f]);
